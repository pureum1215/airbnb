...
<body>
  ...
  <div class="container">
    ...
    <div class="gallery">
      <img src="https://via.placeholder.com/600x400" alt="숙소 대표 이미지" />
    ...
    <div class="info-section">
      <div class="details">
        ...
        <div class="host">
          <strong>호스트: Sylvia 님</strong><br />
          숙소 소개: 예산시장과 도고온천 인근. 감성적인 한옥 숙소에서 휴식을 즐기세요.<br/>
        </div>
      </div>
      ...
      <div class="reservation">
        ...
        <label>체크인</label>
        <input type="date" value="2025-06-09" />
        <label>체크아웃</label>
