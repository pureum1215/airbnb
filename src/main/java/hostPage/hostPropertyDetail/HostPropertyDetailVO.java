...
public class HostPropertyDetailVO {
	...
	public String toString() {
		return "HostPropertyDetailVO [property_delete_yn=" + property_delete_yn + ", property_id=" + property_id
				...
				+ location_continent + ", location_detail=" + location_detail + "]";
	}
