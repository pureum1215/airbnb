...
public class UserDAO {
	...
	/*******************************************************
	 * 사용자, 호스트 회원가입, 로그인, 내 정보 확인 (관리자의 회원 정보 삭제)
	 *******************************************************/
	...
	public String getHostCheck(String userId) {
		conn = getUserDAO();

		try {

			String sql = "select HOST_ID from host where user_id = ? and host_delete_yn ='N'";
			pstmt = conn.prepareStatement(sql);
