...
public class HostPropertyRegisterVO {
	...
	public String toString() {
		return "HostPropertyRegisterVO [property_id=" + property_id + ", location_id=" + location_id + ", amenity_id="
				+ amenity_id + ", property_name=" + property_name + ", property_description=" + property_description
				+ ", price_per_night=" + price_per_night + ", property_room=" + property_room + ", property_bed="
				+ property_bed + ", property_bathroom=" + property_bathroom + ", property_reservation_default="
				+ property_reservation_default + ", property_photo_url=" + property_photo_url + ", amenity_name="
				+ amenity_name + ", location_city=" + location_city + ", location_country=" + location_country
				+ ", location_continent=" + location_continent + ", location_detail=" + location_detail
