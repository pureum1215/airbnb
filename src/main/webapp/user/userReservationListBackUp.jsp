...
<body class="bg-white text-gray-900 font-sans antialiased" onload="pagestart()">
  ...
  <main class="max-w-4xl mx-auto px-6 py-12">
	...
	<br/>
	<div class="space-y-8">
		<div id="reservation-content" class="flex flex-col space-y-4" ></div>
	</div>
				...
				success: function(res) {
    				...
    				if(res.code ==200) {
    					...
    					res.data.forEach(item => {
    						...
    						card += '<img src="/uploads/'+ item.property_photo_url +'" alt="숙소 이미지" class="w-28 h-28 rounded-lg object-cover" />';
    						card += '<div>';
