...
<main class="max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-10">
    ...
    <section class="md:col-span-2 space-y-8">
        ...
        <div>
            ...
            <div class="relative">
                <button id="paymentToggle" class="w-full border rounded-lg p-4 flex justify-between items-center text-left">
                ...
                <div id="paymentOptions" class="absolute z-10 w-full border rounded-lg bg-white shadow-md mt-1 hidden">
                    <div class="hover:bg-gray-100 px-4 py-3 flex items-center cursor-pointer" 
                         onclick="selectPayment('신용카드', 'https://img.icons8.com/ios/50/000000/bank-card-back-side.png')">
                        <img src="https://img.icons8.com/ios/50/000000/bank-card-back-side.png" class="w-6 h-6 mr-2"/>
                        <span>신용카드 또는 체크카드</span>
                    </div>
                    <div class="hover:bg-gray-100 px-4 py-3 flex items-center cursor-pointer" 
                         onclick="selectPayment('페이팔', 'https://img.icons8.com/color/48/000000/paypal.png')">
                        <img src="https://img.icons8.com/color/48/000000/paypal.png" class="w-6 h-6 mr-2"/>
                        <span>페이팔</span>
                    </div>
                    <div class="hover:bg-gray-100 px-4 py-3 flex items-center cursor-pointer" 
                         onclick="selectPayment('Google Pay', 'https://img.icons8.com/color/48/000000/google-pay-india.png')">
                        <img src="https://img.icons8.com/color/48/000000/google-pay-india.png" class="w-6 h-6 mr-2"/>
        ...
        <!-- 결제 버튼 -->
        <br><br><br><br><br>
        <button class="w-full bg-rose-600 hover:bg-rose-700 text-white font-semibold py-3 rounded-lg text-lg">
            확인 및 결제
        </button>
    </section>
    ...
    <aside class="border rounded-xl p-5 shadow-md space-y-4 bg-white">
        ...
        <div class="flex space-x-4">
            <img src="https://a0.muscache.com/im/pictures/placeholder.jpg" class="w-24 h-24 rounded-lg object-cover" alt="숙소">
            <div>
                <h2 class="font-semibold text-sm leading-snug">산이 감싸고 있는 마을숙소<br>“풀길스테이” 도고온천과 예산 시장 인접</h2>
        ...
        <a href="#" class="text-sm underline text-gray-600 block">요금 상세 내역</a>
    </aside>
</main>
